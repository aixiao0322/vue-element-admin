  ...
  <div class="detailsContainer">
    <div class="contLeft">
      <div class="topTit">
        ...
        >
        <div class="info">
          <p class="name"><strong> {{ user.username }} </strong><span
              :class="dutyStatus"
            >{{ dutyStatusTxt }}</span></p>
          ...
          <p>当月基本工资 / 当月岗位工资: {{ formLabelAlign.currentBasicSalary }} /
            {{ formLabelAlign.currentPostWage }}</p>
        </div>
      </div>
      <div>
        <div class="social">
        ...
        <div class="fund">
          <div class="title"> <strong>社保公积金</strong> <span>企业
              {{ socialData.socialSecurityEnterprise + socialData.providentFundEnterprises }}</span>
            <span>个人
              {{ socialData.socialSecurityIndividual + socialData.providentFundIndividual }}</span>
          </div>
          <div class="table">
            <div class="tabTit">
              <div>缴费项目</div>
            ...
            <div class="tabRow">
              ...
              <div />
              <div>
                {{ socialData.socialSecurityEnterprise + socialData.providentFundEnterprises }}
              </div>
              <div>
